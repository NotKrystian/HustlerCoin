...
contract HustlerBond is Ownable {
    ...
    function bondHustlerToken(uint256 deposit) public {  //deposit Hustler Token for staking and log timestamp of transaction
        if(ITREASURY20(treasuryAddress).mintingStatus()) {
            ...
            ITREASURY20(treasuryAddress).bondHustler(deposit, bondToken, currentRate);
